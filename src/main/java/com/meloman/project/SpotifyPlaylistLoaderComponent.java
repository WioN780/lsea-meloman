...
/**
 * Component for importing Spotify playlist data from JSON files
 */
@Component
public class SpotifyPlaylistLoaderComponent {
     ...
     */
    public List<String> generateFilePaths(int numFiles) {
     ...
     */
    public void processAndDisplayResults(List<String> filePaths) {
        Map<String, List<String>> results = processFiles(filePaths);
