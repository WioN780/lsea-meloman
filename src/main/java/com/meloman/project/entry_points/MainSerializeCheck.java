...
public class MainSerializeCheck {
    public static void main(String[] args) throws IOException, ClassNotFoundException{
        ...
        Label label1 = new Label("L1", "Label One", "Parent Label One", new HashSet<>(Arrays.asList("SubLabel1", "SubLabel2")), new ArrayList<>(), new HashSet<>(Arrays.asList("www.labelone.com")), "contact@labelone.com");
        Label label2 = new Label("L2", "Label Two", "Parent Label Two", new HashSet<>(Arrays.asList("SubLabel3", "SubLabel4")), new ArrayList<>(), new HashSet<>(Arrays.asList("www.labeltwo.com")), "contact@labeltwo.com");
